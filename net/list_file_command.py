...
import command_line as cl       #importing the function that implment command  line argument
import sys                      #internal python library for implmenting command line interface
